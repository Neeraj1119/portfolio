...
export default function ResumePage() {
  ...
  const nameLetters = "Neeraj Patil Resume ".split("");
                    ...
                    <div className="space-y-4 sm:space-y-6 flex-1">
                      <div>
                        ...
                        <p className="text-sm text-neutral-400">
                          ...
                          development with Java, Spring Boot, ASP.NET Core, and 
                          ReactJS. I specialize in building scalable, production-ready 
                          web applications with clean REST API architecture.
                        </p>
                      </div>

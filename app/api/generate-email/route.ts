...
async function handler(req: NextRequest) {
  try {
    ...
    const systemPrompt = `You are an AI assistant helping a visitor draft an email to Neeraj Patil. 
    The email should be written from the perspective of the visitor/user, addressed to Neeraj.
    Use the user's prompt to determine the intent (e.g., job offer, collaboration, question).
    
    Requirements:
    - Address the email to "Neeraj" or "Mr. Patil".

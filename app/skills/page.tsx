...
const skills = {
  ...
  "Backend Development": [
    ...
    { name: "ASP.NET Core", icon: <SiDotnet className="text-[#512BD4]" /> },
    { name: "Hibernate", icon: <SiHibernate className="text-[#59666C]" /> },
    { name: "REST APIs", icon: <FiServer className="text-[#00A3A3]" /> },
    { name: "Servlet/JSP", icon: <SiApachetomcat className="text-[#F8DC75]" /> },
  ],
  "Databases": [
  ...
  "Tools & Technologies": [
    ...
    { name: "Maven", icon: <FiTool className="text-[#C71A36]" /> },
  ],
};

const categoryIcons = {
  "Frontend Development": <FiCode className="w-6 h-6" />,
  "Backend Development": <FiServer className="w-6 h-6" />,

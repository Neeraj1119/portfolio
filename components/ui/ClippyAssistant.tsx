...
const OPEN_CHAT_PHRASES = [
    "Let's chat! Ask me anything about Neeraj! 💬",
    "I'm here to help! What would you like to know? 🤔",
    "Ready to assist! Fire away with your questions! 🔥",
    "Hey there! Let's explore Neeraj's work together! 🚀",
...
const IDLE_CLICK_PHRASES = [
    ...
    "I know a lot about Neeraj! Try me! 😎",
    ...
    useEffect(() => {
        ...
        async function init() {
            try {
                ...
                // Grand entrance!
                agent.play("Wave");
                agent.speak("Hey! I'm Clippy! Click me to chat with Neeraj's AI assistant! 📎");
            } catch (err) {

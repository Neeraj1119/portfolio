...
EMart – Full Stack E-Commerce Platform | Java, Spring Boot, ASP.NET Core (.NET 8), MySQL, JWT, ReactJS
GitHub: https://github.com/Neeraj1119

Architected a dual-backend e-commerce system (Spring Boot + .NET 8) with JWT authentication and Google OAuth2 sign-on, built as part of the C-DAC Advanced Computing curriculum.
...
Implemented automated post-payment workflows including PDF invoice generation and email delivery, reducing fulfillment notification time to near-zero.

128-Point FFT Processor for MIMO-OFDM | MATLAB, Radix-2, Radix-8, Signal Processing

Designed a high-efficiency 128-point FFT processor using Radix-2 and Radix-8 algorithms in MATLAB for real-time signal processing in MIMO-OFDM communication systems.
...
Organised a seminar on advanced antenna systems with 200+ attendees, driving department-wide technical engagement.
...
Delivered STEM education sessions in primary schools, providing career mentorship to 100+ students.

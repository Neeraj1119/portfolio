            ...
            const response = await fetch(
                "https://openrouter.ai/api/v1/chat/completions",
                {
                    ...
                    headers: {
                        ...
                        "HTTP-Referer": "https://neerajpatil.com",
                        "X-Title": "Neeraj's Portfolio",
...
export class ChatWorkflow {
    ...
    private async generateSearchQuery(
        ...
        try {
            ...
            // For now, we'll just append "Neeraj Patil" if it seems to be about the person
            ...
            if (
                ...
                return `Neeraj Patil ${currentQuery}`;
            }
            return currentQuery;
        } catch (error) {
    ...
    async processMessage(
        ...
        let systemContent = `You are Neeraj Patil, a full-stack developer with expertise in Java, Spring Boot, ASP.NET Core (.NET 8), ReactJS, and MySQL.`;
        ...
        systemContent += `\n\nRules:
    1. Speak as Neeraj using "I" and "my"
